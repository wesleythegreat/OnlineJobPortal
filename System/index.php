...
<head>
	...
	<title>PUBLIC EMPLOYMENT SERVICES OFFICE - Job Portal</title>
    ...
    <meta property="og:description" content="PESO / Job Portal" />
...
<body class="home">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/pesologo.png');">
				<div class="container">

					<h1>your bright future starts here now</h1>
					<p>Finding your next job or career on PESO </p>
